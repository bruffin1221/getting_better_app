class Objective4sController < ApplicationController
  ...
  post "/objective4s" do
    ...
    if !params[:strategy1][:name].empty?
      ...
      strategy1.update(objective4_id: @objective.id)
    end
    ...
    if !params[:strategy2][:name].empty?
      ...
      strategy2.update(objective4_id: @objective.id)
    end
    ...
    if !params[:strategy3][:name].empty?
      ...
      strategy3.update(objective4_id: @objective.id)
    end
    ...
    if !params[:strategy4][:name].empty?
      ...
      strategy4.update(objective4_id: @objective.id)
    end
